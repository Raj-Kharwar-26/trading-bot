...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        self.ticker = None
        # Our RAG strategy context, injected into the PM prompt (appended to the
        # memory-log past context in _run_graph). Set before calling propagate().
    ...
    def _run_graph(self, company_name, trade_date, asset_type: str = "stock"):
        ...
        if self.strategy_context:
            past_context = (past_context + "\n\n" if past_context else "") + self.strategy_context
